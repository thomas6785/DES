...
set rc [catch {
  ...
  add_files -quiet C:/Users/lab/Documents/EmbeddedSystems/Wednesday/AidanThomasTinu/SoC/DES_SoC/Hardware/DemoSystem.runs/synth_1/AHBDCD.dcp
  ...
  set_property netlist_only true [get_files C:/Users/lab/Documents/EmbeddedSystems/Wednesday/AidanThomasTinu/SoC/DES_SoC/Hardware/DemoSystem.runs/blk_mem_8Kword_synth_1/blk_mem_8Kword.dcp]
  ...
  read_xdc -mode out_of_context -ref blk_mem_8Kword c:/Users/lab/Documents/EmbeddedSystems/Wednesday/AidanThomasTinu/SoC/DES_SoC/Hardware/DemoSystem.srcs/sources_1/ip/blk_mem_8Kword/blk_mem_8Kword_ooc.xdc
  set_property processing_order EARLY [get_files c:/Users/lab/Documents/EmbeddedSystems/Wednesday/AidanThomasTinu/SoC/DES_SoC/Hardware/DemoSystem.srcs/sources_1/ip/blk_mem_8Kword/blk_mem_8Kword_ooc.xdc]
  ...
  link_design -top AHBDCD -part xc7a100tcsg324-1
...
set rc [catch {
  ...
  catch {report_drc -file AHBDCD_drc_opted.rpt}
...
set rc [catch {
  ...
  catch {write_hwdef -file AHBDCD.hwdef}
  place_design 
  write_checkpoint -force AHBDCD_placed.dcp
  catch { report_io -file AHBDCD_io_placed.rpt }
  catch { report_utilization -file AHBDCD_utilization_placed.rpt -pb AHBDCD_utilization_placed.pb }
  catch { report_control_sets -verbose -file AHBDCD_control_sets_placed.rpt }
...
set rc [catch {
  ...
  catch { report_drc -file AHBDCD_drc_routed.rpt -pb AHBDCD_drc_routed.pb }
  catch { report_timing_summary -warn_on_violation -max_paths 10 -file AHBDCD_timing_summary_routed.rpt -rpx AHBDCD_timing_summary_routed.rpx }
  catch { report_power -file AHBDCD_power_routed.rpt -pb AHBDCD_power_summary_routed.pb }
  catch { report_route_status -file AHBDCD_route_status.rpt -pb AHBDCD_route_status.pb }
  catch { report_clock_utilization -file AHBDCD_clock_utilization_routed.rpt }
