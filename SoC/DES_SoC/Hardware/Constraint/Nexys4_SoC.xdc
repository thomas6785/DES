# This file is a constraint file for the Nexys4 board in the SoC assignment.
# Signals that are not needed in the minimum system are commented out.
# If you need to use any other signals, uncomment two set property statements for each signal
# and make the signal names match the ports on the top-level module

# Configuration IO bank settings
...
# Switches - the 16 slide switches, accessed as one 16-bit signal called sw
...
# LEDs - the line of 16 LEDs above the switches, accedd as one 16-bit signal called led
...
# Multi-colour LEDs
#Bank = 34, Pin name = IO_L5P_T0_34,		RGB1_red      	Sch name = LED16_R
set_property PACKAGE_PIN K5 [get_ports {rgbLED[0]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {rgbLED[0]}]
#Bank = 15, Pin name = IO_L5P_T0_AD9P_15,	RGB1_Green		Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports {rgbLED[1]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {rgbLED[1]}]
#Bank = 35, Pin name = IO_L19N_T3_VREF_35,	RGB1_Blue		Sch name = LED16_B
set_property PACKAGE_PIN F6 [get_ports {rgbLED[2]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {rgbLED[2]}]
#Bank = 34, Pin name = IO_0_34,				RGB2_Red		Sch name = LED17_R
set_property PACKAGE_PIN K6 [get_ports {rgbLED[3]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {rgbLED[3]}]
#Bank = 35, Pin name = IO_24P_T3_35,		RGB2_Green		Sch name =  LED17_G
set_property PACKAGE_PIN H6 [get_ports {rgbLED[4]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {rgbLED[4]}]
#Bank = CONFIG, Pin name = IO_L3N_T0_DQS_EMCCLK_14,	RGB2_Blue	Sch name = LED17_B
...
# Accelerometer - the ADXL362 device.  Slave select is active low.
...
set_property IOSTANDARD LVCMOS33 [get_ports aclSSn]
...
# Pmod Header JA - a connector on the side of the Nexys-4 board
