...
#                script (type 'blk_mem_8Kword.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_mem_8Kword xil_defaultlib.glbl -o blk_mem_8Kword_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_mem_8Kword_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_8Kword_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_8Kword_simv.daidir vcs_lib c.obj)
